        ...
        <div className="flex items-center gap-3 h-12">
          ...
          {showParticipants && (
            <div className="flex items-center gap-2 flex-shrink-0 ml-auto">
              ...
              {/* Participants Count */}
              <div className="flex items-center gap-1.5 px-2.5 py-1 bg-indigo-500/10 border border-indigo-500/30 rounded-lg whitespace-nowrap">
              ...
              {/* Room ID */}
              {roomId && (
                <div className="hidden sm:flex items-center gap-2 px-2.5 py-1 bg-slate-800/50 border border-slate-700/50 rounded-lg whitespace-nowrap">
